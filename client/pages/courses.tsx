                    ...
                    <div className="courses-page--about">
                        ...
                        <div className="courses-page--name">
                            ...
                            <div className="viewers">
                                <Eye size={17} />
                                <p className="paragraph-medium-small Eina-semibold">{CoursesJson.aboutCourses.aboutCourse.peopleWatched}</p>
                            </div>
                        </div>
                        ...
                        <div className="courses-page--about__heading">
                            {!displayName ?
                                null
                                :
                                <p className="paragraph-regular-Noto paragraph-medium-small">ვიდეოს დასახელება - {displayName}</p>
                            }
                        </div>
                    </div>
