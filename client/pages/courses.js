                                ...
                                <div className="card_container">
                                    ...
                                    <div className="card_container__info">
                                            <div className="card_container__info--details">
                                                <div className="details_finished"></div>
                                                <div className="details_heading">
                                                    <p className="paragraph-regular-Noto paragraph-medium-small ">რა არის javascript <span className="Eina-semibold paragraph-smallest">(5 m)</span></p>
                                                </div>
                                            ...
                                            <div className="details_finished"></div>
                                                <div className="details_heading">
                                                    ...
                                                    გაკეთება შეგიძლია <span className="Eina-semibold paragraph-smallest">(5 m)</span></p>
                                                </div>
                                            ...
                                            <div className="details_finished"></div>
                                                <div className="details_heading">
                                                    <p className="paragraph-regular-Noto paragraph-medium-small ">რა არის ცვლადები <span className="Eina-semibold paragraph-smallest">(5 m)</span></p>
                                                </div>
