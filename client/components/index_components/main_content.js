                ...
                <div className="courses--input">
                    ...
                    <div className="sorting">
                        <div className="sorting__heading">
                            <p className="paragraph-regular-Noto paragraph-medium">დახარისხება:</p>
                        </div>
                ...
                <div className="courses--cards">
                    <div className="card">
                        ...
                        <div className="card__like">
                            <label href="#"
                                className="label heading-semi-bold-Noto paragraph-smallest">ბესტსელერი</label>
                    ...
                    <div className="card">
                        ...
                        <div className="card__raiting">
                            <div className="card__raiting--container">
                                ...
                                <div className="numbers">
                                    <p className="heading-semi-bold-Noto paragraph-small">4.5 (12)</p>
                                </div>
                            </div>
                            <div className="card__raiting--name">
                                <p className="heading-semi-bold-Noto  paragraph-small">ბექა არაბიძე</p>
                        ...
                        <div className="card__like">
                            <a href="#" className="btn btn-green bestseller">ბესთსელერი</a>
