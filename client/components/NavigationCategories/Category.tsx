...
import {MainCategoryToggleAnimation,MainCategoryChildren,
...
import {handleFetchMainCategory,handleFetchSubCategoryClick} from "components/utils/Category/CategoryFunctions";
  ...
  return (
    <>
      <motion.ul
        ...
        onMouseEnter={() => setIsMouseleftCategory(false)}
      ...
      >
        {mainCategories.map((data) => (
          <Maincategory
            handleFetchMainCategory={() => handleFetchMainCategory(data.id,subCategories,setRendersSubNames)}
        ...
        >
          {rendersSubNames &&
            rendersSubNames.map((data) => (
              <SubCategory
                handleFetchSubCategoryClick={() => handleFetchSubCategoryClick(data.id,    subSubCategories,
                setRendersSubSubNames
                  )
                }
                setIsSubCategoryChosen={setIsSubCategoryChosen}
                setIsMouseleftCategory={setIsMouseleftCategory}
                key={data.id}
                id={data.id}
                name={data.name}
              />
