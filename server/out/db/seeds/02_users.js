...
function seed(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex(tableNames_1.default.users).insert([
                        {
                            id: 1,
                            full_name: "rowValue1",
                            email: "email",
                            ...
                            detailed_rattings: JSON.stringify(defaults_1.user.rating_starts),
                            ratting: 2,
                            verified: true,
                            isInstructor: true,
                            subscriber_count: 123,
                            show_details_public: true,
                            personal_detales: JSON.stringify(defaults_1.user.socials),
